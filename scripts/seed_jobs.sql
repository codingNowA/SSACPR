...
-- 互联网/软件
INSERT INTO jobs (title, company, industry, location, salary_range, experience_required, education_required, description, requirements, skills, company_type, source) VALUES
('Python后端开发工程师', '字节跳动', '互联网', '北京', '20K-35K', '1-3年', '本科',
 ...
 '["Python", "FastAPI", "Django", "PostgreSQL", "Redis", "Docker", "Kubernetes", "微服务"]'::jsonb, '民营', 'seed_test'),
...
('前端开发工程师', '腾讯科技', '互联网', '深圳', '18K-30K', '1-3年', '本科',
 ...
 '["JavaScript", "TypeScript", "React", "Vue", "Webpack", "Vite", "HTML", "CSS", "Sass"]'::jsonb, '民营', 'seed_test'),
...
('全栈开发工程师', '阿里巴巴', '互联网', '杭州', '25K-40K', '3-5年', '本科',
 ...
 '["Python", "JavaScript", "React", "Flask", "MySQL", "Redis", "MongoDB", "Hadoop", "Spark"]'::jsonb, '民营', 'seed_test'),
...
('Java高级开发工程师', '美团', '互联网', '北京', '25K-45K', '3-5年', '本科',
 ...
 '["Java", "Spring", "SpringBoot", "MySQL", "PostgreSQL", "Kafka", "分布式", "微服务", "Redis"]'::jsonb, '民营', 'seed_test'),
...
('DevOps工程师', '华为技术', '互联网', '成都', '18K-28K', '1-3年', '本科',
 ...
 '["Docker", "Kubernetes", "K8s", "Linux", "Jenkins", "CI/CD", "Terraform", "Nginx", "Git"]'::jsonb, '民营', 'seed_test'),
...
('量化研究员', '中信证券', '金融', '上海', '30K-50K', '1-3年', '硕士',
 ...
 '["Python", "Pandas", "NumPy", "Scikit-learn", "SQL", "Machine Learning", "MATLAB", "R"]'::jsonb, '国企', 'seed_test'),

('数据分析师', '招商银行', '金融', '深圳', '15K-25K', '应届', '本科',
 '负责银行零售业务数据分析，搭建数据报表体系，提供业务决策支持。',
 '熟练使用SQL查询；熟悉Python数据分析工具；了解Tableau/Power BI可视化工具；有统计学基础。',
 '["SQL", "Python", "Pandas", "Excel", "Power BI", "Tableau"]'::jsonb, '国企', 'seed_test'),
...
('Software Engineer (Backend)', 'Microsoft', '互联网', '上海', '30K-55K', '1-3年', '本科',
 ...
 '["Python", "Go", "Golang", "PostgreSQL", "Redis", "Docker", "Kubernetes", "分布式", "微服务", "Azure"]'::jsonb, '外企', 'seed_test'),
